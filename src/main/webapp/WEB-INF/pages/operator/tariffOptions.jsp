...
<div class="inner cover">
    <h1 class="cover-heading">${tariffName}'s options</h1>
    <br/>
    <table class="table">
        <thead>
        <tr>
        ...
        <c:forEach var="option" items="${options}">
            <tr>
                ...
                <td>
                    <form action="<c:url value="/dropTariffOption"/>" method="post">
                        <button class="btn btn-sm btn-default btn-block" type="submit">Delete</button>
